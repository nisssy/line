...
import type { BasicInfo, Step1Status, ChatMessage, Supervisor } from "@/types/workflow"
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table"
import { FileText, AlertCircle, Send, Database, ClipboardList, ArrowRight, X, Paperclip } from "lucide-react"
          ...
          <div className="space-y-2">
            ...
            {applicationUploaded ? (
              ...
              >
                ...
                <span className="text-sm text-foreground underline underline-offset-2">{uploadedFileName || "LINE広告申込書.xlsx"}</span>
            ...
            <>
              <div className="border-t pt-6">
                <BasicInfoForm
                  ...
                  disabled={status === "awaiting_review" || status === "approved"}
                  carryoverHistory={SAMPLE_CARRYOVER_DATA}
                />
              </div>
